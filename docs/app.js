...
const elSettings = $                   ("settings-editor");
const elTabDevice = $                   ("tab-device");
const elTabStats = $                   ("tab-stats");
...
function syncTimerModeUI() {
  ...
  const durLabel = $                  ("t-duration").closest("label")               ;
...
$                 ("timer-form").onsubmit = async (e) => {
  ...
  const mode            = targetMs && targetMs > 0 ? "down" : radioMode === "down" ? "down" : "up";
